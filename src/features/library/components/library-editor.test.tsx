...
const media = { id: 1, mediaType: "anime" as const, title: "Cowboy Bebop", imageUrl: "https://example.test/cowboy-bebop.webp", malUrl: "https://myanimelist.net/anime/1", format: "TV", progressTotal: 26, genres: ["Action"], themes: ["Space"], studios: ["Sunrise"], creators: [] };

describe("LibraryEditor", () => {
  it("prepopulates every editable field for an existing entry", () => {
    render(<LibraryEditor media={media} initialEntry={{ status: "paused", progress: 12, score: 9, favourite: true, notes: "Continue with episode 13." }} />);
