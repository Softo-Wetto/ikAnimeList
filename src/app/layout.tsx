...
export default async function RootLayout({ children }: Readonly<{ children: ReactNode }>) {
  ...
  return <html data-scroll-behavior="smooth" lang="en" suppressHydrationWarning><body><ThemeProvider nonce={nonce}><div className="relative flex min-h-dvh flex-col overflow-x-clip"><div aria-hidden="true" className="ambient ambient-one" /><div aria-hidden="true" className="ambient ambient-two" /><SiteHeader /><main className="relative flex-1">{children}</main><SiteFooter /></div></ThemeProvider></body></html>;
}
